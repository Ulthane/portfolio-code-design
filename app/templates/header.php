...
<header class="bg-primary">
    <div class="d-flex justify-content-between">
        ...
        <div class="d-flex">
            <div class="d-flex align-items-center name">
                <?php if (empty($_SESSION['username'])) { ?>
                    <a class="text-secondary mx-3" href="index.php?page=login">connexion</a>
                <?php } else { ?>
                    <div class="d-flex align-items-center">
                        <a class="text-secondary m-0 mx-3" href="index.php?page=admin&category-adm=pro_category&type=add"><?= strtolower(str_replace(' ', '-', $_SESSION['username'])) ?></a>
        ...
        <div class="contact">
            <a class="text-secondary" href="index.php?page=contact">_contacter-moi</a>
        </div>
    </div>
</header>
